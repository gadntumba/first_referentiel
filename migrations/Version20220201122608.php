 ...
 */
final class Version20220201122608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE productor ADD latitude DOUBLE PRECISION NOT NULL, ADD longitude DOUBLE PRECISION NOT NULL, ADD altitude DOUBLE PRECISION NOT NULL, ADD type_piece_of_identification VARCHAR(255) NOT NULL, ADD number_piece_of_identification VARCHAR(255) NOT NULL, ADD photo_piece_of_identification VARCHAR(255) NOT NULL, ADD household_size INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE productor DROP latitude, DROP longitude, DROP altitude, DROP type_piece_of_identification, DROP number_piece_of_identification, DROP photo_piece_of_identification, DROP household_size');
    }
}
