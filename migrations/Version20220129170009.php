 ...
 */
final class Version20220129170009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiching_activity ADD source_of_supply_activity_id INT DEFAULT NULL, ADD address_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiching_activity DROP source_of_supply_activity_id, DROP address_id');
    }
}
