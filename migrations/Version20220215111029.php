 ...
 */
final class Version20220215111029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE house_keeping (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, nim VARCHAR(255) NOT NULL, reference VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D70C549F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
