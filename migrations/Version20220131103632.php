 ...
 */
final class Version20220131103632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agricultural_activity (id INT AUTO_INCREMENT NOT NULL, productor_id INT DEFAULT NULL, exploited_area_id INT DEFAULT NULL, source_of_supply_activity_id INT DEFAULT NULL, adress_id INT DEFAULT NULL, date DATE NOT NULL, goal LONGTEXT NOT NULL, INDEX IDX_40DB987A55BB310E (productor_id), INDEX IDX_40DB987AA02BB56 (exploited_area_id), UNIQUE INDEX UNIQ_40DB987A4C5C771A (source_of_supply_activity_id), INDEX IDX_40DB987A8486F9AC (adress_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nfc (id INT AUTO_INCREMENT NOT NULL, productor_id INT DEFAULT NULL, metadata JSON NOT NULL, INDEX IDX_5A14C3FB55BB310E (productor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE productor (id INT AUTO_INCREMENT NOT NULL, level_study_id INT DEFAULT NULL, housekeeping_id INT DEFAULT NULL, monitor_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, nui VARCHAR(255) NOT NULL, INDEX IDX_173A0706A19A639 (level_study_id), INDEX IDX_173A0702839160B (housekeeping_id), INDEX IDX_173A0704CE1C902 (monitor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE smartphone (id INT AUTO_INCREMENT NOT NULL, metadata JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
