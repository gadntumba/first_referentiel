 ...
 */
final class Version20220426135433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock_raising_activity ADD stock_raising_activity_sub_type_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stock_raising_activity ADD CONSTRAINT FK_2BE2B538EB633190 FOREIGN KEY (stock_raising_activity_sub_type_id) REFERENCES stock_raising_activity_sub_type (id)');
        $this->addSql('CREATE INDEX IDX_2BE2B538EB633190 ON stock_raising_activity (stock_raising_activity_sub_type_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stock_raising_activity DROP FOREIGN KEY FK_2BE2B538EB633190');
        ...
        $this->addSql('DROP INDEX IDX_2BE2B538EB633190 ON stock_raising_activity');
        $this->addSql('ALTER TABLE stock_raising_activity DROP stock_raising_activity_sub_type_id');
